...
model = torchvision.models.detection.maskrcnn_resnet50_fpn_v2(pretrained=True,trainable_backbone_layers=5)  # load an instance segmentation model pre-trained pre-trained on COCO
