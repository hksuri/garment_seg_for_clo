...
backbone = nn.Sequential(conv1, bn1, resnet18_relu, resnet18_max_pool, 
                         layer1, layer2, layer3, layer4)
# We need the output channels of the last convolutional layers from
# the features for the Mask RCNN model.
...
model = MaskRCNN(backbone, num_classes=14,
             rpn_anchor_generator=anchor_generator,
              ...
              mask_roi_pool=mask_roi_pooler, trainable_backbone_layers=5,mean=[0.485, 0.456, 0.406] ,std=[0.229, 0.224, 0.225])
